...
Version: **1.0.11** — Bags + Quest Hub + Cast Buffs level-gated to Character Level
Canonical: backend/app/{main,engine,spell_buffs,quest_hub,quest_guides,...}.py + frontend App.jsx
