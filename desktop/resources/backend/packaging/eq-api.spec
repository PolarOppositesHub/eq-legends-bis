...
hidden = [
    ...
    "backend.app.races",
    "backend.app.parser",
    "backend.app.parser.api",
    "backend.app.parser.breakdown",
    "backend.app.parser.classify",
    "backend.app.parser.discover",
    "backend.app.parser.fights",
    "backend.app.parser.models",
    "backend.app.parser.service",
    "backend.app.parser.sources",
    "backend.app.parser.store",
    "backend.app.parser.tail",
    "build_planner",
    "build_xlsx",
    "decode_local",
]
